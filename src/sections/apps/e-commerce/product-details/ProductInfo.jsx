        ...
        <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
          <Stack spacing={2.5}>
            ...
            <Stack direction="row" alignItems="center" spacing={1}>
              ...
              <IconButton color="secondary" sx={{ ml: 'auto', '&:hover': { bgcolor: 'transparent' } }} >
                <ArrowUpOutlined style={{ fontSize: '1.15rem', color: theme.palette.error.dark }} />
              </IconButton>
          ...
          <Stack direction="row" alignItems="center" spacing={3} sx={{ mt: 4 }}>
            <TextField id="outlined-basic" placeholder="max price" fullWidth />
            <TextField id="outlined-basic" placeholder="min price" fullWidth/>
            <TextField id="outlined-basic" placeholder="basic price" fullWidth/>
          </Stack> 
